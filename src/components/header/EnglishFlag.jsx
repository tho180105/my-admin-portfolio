...
const EnglishFlag = () => (
  <>
   <svg
    ...
    className="my-icon"  // Bạn có thể thêm class để áp dụng CSS
  >
    <style type="text/css">
      {`.st0{fill:#FEFEFE;} .st1{fill:#C8102E;} .st2{fill:#012169;}`}
    </style>
    <g>
      <path className="st0" d="M2.87,38.4h49.46c1.59-0.09,2.87-1.42,2.87-3.03V3.03c0-1.66-1.35-3.02-3.01-3.03H3.01 C1.35,0.01,0,1.37,0,3.03v32.33C0,36.98,1.28,38.31,2.87,38.4L2.87,38.4z" />
